...
\author{
  ...
  \IEEEauthorblockA{\textit{JPMorgan Chase \& Co.} \
  bhavyateja.potineni@chase.com}
  \and
  \IEEEauthorblockN{Lohit Giri}
  \IEEEauthorblockA{\textit{JPMorgan Chase \& Co.} \
  lohit.giri@chase.com}
  \and
  \IEEEauthorblockN{Vadim Kutsyy}
  \IEEEauthorblockA{\textit{JPMorgan Chase \& Co.} \
  vadim.kutsyy@jpmchase.com}
  \and
  \IEEEauthorblockN{Rajasekhar Pentakota}
  \IEEEauthorblockA{\textit{JPMorgan Chase \& Co.} \
  rajasekhar.pentakota@chase.com}
}
\author{
  \IEEEauthorblockN{Bhavyateja Potineni\IEEEauthorrefmark{1}\thanks{\IEEEauthorrefmark{1}Corresponding author: \texttt{bhavyateja.potineni@chase.com}}}
  \IEEEauthorblockA{\textit{JPMorgan Chase \& Co.} \
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig5_sensitivity_analysis.png}
