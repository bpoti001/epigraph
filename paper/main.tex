...
To evaluate whether upstream retrieval advantages transfer to downstream generative tasks, we evaluated zero-shot question-answering across stratified LoCoMo dialogues using a local 7B-parameter LLM (Qwen2.5-VL-7B) on Apple Silicon GPU. Table \ref{tab:closed_loop} reports Token F1, Exact Match (EM), and ROUGE-L across all evaluated contexts.
